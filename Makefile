...
SAIL_REGS_SRCS = riscv_types_cap.sail riscv_reg_type.sail riscv_types_revnode.sail riscv_cap_tags.sail \
				riscv_freg_type.sail riscv_regs.sail riscv_pc_access.sail riscv_sys_regs.sail
...
SAIL_ARCH_SRCS += riscv_vmem_types.sail $(SAIL_REGS_SRCS) $(SAIL_SYS_SRCS) riscv_platform.sail riscv_aux_capstone.sail 
