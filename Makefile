...
SAIL_DEFAULT_INST += riscv_insts_capstone_debug.sail riscv_insts_capstone_cap.sail \
					 riscv_insts_capstone_mem.sail riscv_insts_capstone_ctrflow.sail
...
SAIL_ARCH_SRCS += riscv_mem.sail riscv_aux_capstone.sail $(SAIL_VM_SRCS)
...
c_emulator/riscv_sim_$(ARCH): generated_definitions/c/riscv_model_$(ARCH).c $(C_INCS) $(C_SRCS) $(SAIL_LIB_DIR)/*.c $(SOFTFLOAT_LIBS) Makefile
