...
SAIL_REGS_SRCS = riscv_types_cap.sail riscv_reg_type.sail riscv_types_revnode.sail riscv_freg_type.sail riscv_regs.sail riscv_pc_access.sail riscv_sys_regs.sail
